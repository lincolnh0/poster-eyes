<template>
  <div v-if="artists.length" class="py-6">
    ...
    <div class="grid-cols-3 gap-8 grid w-full">
      <V3TracksCard v-for="track in track_results" :key="track.artist" :artist="track.artist" :tracks="track.tracks"/>
    </div>
...
import V3TracksCard from "@/components/variants/v3/V3TracksCard.vue";
export default {
  name: "V3ArtistResults",
  components: {V3TracksCard},
