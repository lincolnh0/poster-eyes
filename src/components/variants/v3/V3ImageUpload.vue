<template>
  ...
  <div v-show="imageSrc">
    <V3ImageCrop :key="imageSrc" :src="imageSrc" :reset="resetImage" :submitArtists="addArtists"/>
  </div>
</template>

<script>
import V3ImageCrop from "@/components/variants/v3/V3ImageCrop.vue";

export default {
  name: "V3ImageUpload",
  props: ["addArtists"],
  components: {V3ImageCrop},
  data() {
    return {
      imageSrc: "",
    }
